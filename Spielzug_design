...
1. Nachdem ein Spielzug getätigt wird, leuchtet der Rand der bewegten Disk in der Farbe **#f8fafc**.  
...
6. Wenn ein nicht erlaubter Zug gemacht wird, erscheint die Nachricht:  
   > **"This move is not allowed"**  
   unterhalb der Buttons.  
